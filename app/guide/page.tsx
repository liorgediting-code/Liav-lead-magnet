...
const rules = [
  ...
  },
  {
    ...
    dialogue: {
      ...
      seller:
        "אשמח לתת לך את כל הפרטים על ההשקעה בליווי. לפני שאני נוקב במספר, מסקרן אותי לדעת: מה בדיוק תפס אותך במודעה, ומה גרם לך להשאיר פרטים דווקא עכשיו?",
    },
  },
  {
    number: 3,
        ...
        <div className="relative max-w-[680px] mx-auto px-5 py-16 md:py-24">
          <FadeIn>
            ...
            <div className="flex flex-col gap-5 text-[17px] leading-[1.75] text-white/75">
              <p>
                התסכול והריקנות, והחרדה שתוקפת אותך בכל צלצול שזה עוד לקוח שהולך
