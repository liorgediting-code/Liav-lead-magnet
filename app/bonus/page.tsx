  ...
  return (
    <main className="flex-1">
      ...
      <CalendlyCallout
        ...
        intro="ראית את התבנית בפעולה — עכשיו הגיע הזמן ליישם אותה ספציפית על המוצר שלך. באימון מכירות במתנה אנחנו עושים את זה יחד, צעד-צעד."
        featurePreset="bonus"
        variant="dark"
        buttonText="קבע אימון מכירות במתנה"
