...
import { CheckCircle2, ShieldAlert, Sparkles, ArrowLeft } from "lucide-react";
        ...
        <div className="max-w-[680px] mx-auto px-5 py-14 text-center">
          <div className="inline-flex items-center gap-2 bg-primary/15 border border-primary/30 rounded-full px-4 py-1.5 mb-6">
            ...
            <span className="text-primary text-sm font-medium">
              תהליך המכירה המלא, שלב אחר שלב
            </span>
          </div>
          <h1 className="text-3xl md:text-4xl font-extrabold leading-tight mb-4">
            תבנית המכירה שסוגר לי וללקוחות שלי{" "}
            <span className="text-primary">עסקאות בקלות:</span>
          </h1>
          <p className="text-base text-white/70 max-w-lg mx-auto">
            תהליך המכירה האפקטיבי שלי ב-8 שלבים, עם תסריטים מוכנים לכל רגע
            בשיחה.
          </p>
        </div>
      </section>
          ...
          <div className="px-6 py-6 md:px-7 md:py-7">
            ...
            <div className="flex flex-col gap-3 text-[15px] text-foreground/85 leading-relaxed">
              <p>
                ...
                . המוח שלנו סורק קודם את הסיכון, את האיום, את האכזבה
                האפשרית, הרבה לפני שהוא רואה את ההזדמנות. במכירה זו לא
                חולשה שצריך להתחבא ממנה, זו מציאות שצריך לעבוד איתה.
              </p>
              <p>
                המטרה שלך בשיחת המכירה היא{" "}
                <span className="font-bold text-foreground">לא לייפות</span>,
                לא להבטיח שהכול יהיה ורוד ולא לטייח את הקשיים. ברגע שתעשה
                את זה, הלקוח ירגיש את זה. ההגנות שלו יעלו, והאמון יישבר
                עוד לפני שאמרת מחיר.
              </p>
              <p>
                המהלך האמיתי הוא ההפך הגמור:{" "}
                <span className="font-bold text-foreground">אתה</span> זה
                שפותח את הצד השלילי. מדבר על האתגרים שיעמדו בדרך, על
                הקושי, על הרגעים שבהם הוא ירצה לוותר. מראה לו שאתה רואה את
                התמונה המלאה, לא רק את חלון הראווה.
              </p>
              <div className="rounded-xl bg-primary/[0.10] border border-primary/30 px-4 py-3">
                <p className="text-[14px] text-foreground/90 leading-relaxed">
                  <span className="font-black text-foreground">
                    קריטי לעשות את זה כמה שיותר מוקדם בשיחה.
                  </span>{" "}
                  ככל שתפתח את הצד השלילי מהר יותר, ככה תייצר יותר אמון,
                  תוריד את הסקפטיות של הלקוח, ותהפוך בעיניו מ&quot;עוד מוכר
                  שמנסה לדחוף לי משהו&quot; ל&quot;בן אדם שמבין אותי
                  באמת&quot;. כל דקה שמתעכבת היא דקה שבה הוא בונה הגנות
                  נגדך.
                </p>
              </div>
              <p>ואז, אחרי שהנחת את האמת על השולחן, תגיד לו:</p>
              <div className="rounded-xl bg-primary/[0.08] border border-primary/20 px-4 py-3">
                <p className="font-bold text-foreground text-[15px] leading-relaxed">
                  &quot;אם תעמוד בזה, תצא מהצד השני אדם אחר. חזק יותר,
                  ממושמע יותר, בטוח יותר בעצמך. כי עמדת במילה שאמרת
                  לעצמך, למרות הכול.&quot;
                </p>
              </div>
              <p className="text-sm text-muted-foreground italic">
                זו לא הבטחה לתוצאה. זו הבטחה לזהות. וזה מה שלקוחות באמת
                קונים.
              </p>
            </div>
          </div>
      ...
      <section className="bg-navy">
        <div className="max-w-[680px] mx-auto px-5 py-16 md:py-20 text-center">
          ...
          <p className="text-white/65 text-base leading-relaxed mb-4 max-w-md mx-auto">
            הכנתי עוד בונוס בשביל מתקדמים יותר שמכירים את תהליך המכירה,
            ורוצים לצלול יותר לעומק.
          </p>
          <p className="text-white/85 text-base font-semibold leading-relaxed mb-8 max-w-md mx-auto">
            ...
            <span className="text-primary">בחיים</span> לעשות בשיחה, ובדיוק
            הם אלו שמפילים לך את העסקאות.
          </p>
