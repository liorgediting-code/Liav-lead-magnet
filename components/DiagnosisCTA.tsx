...
const callPoints = [
  {
    ...
    desc: "אני המוכר, אתה הלקוח. תרגיש על הגוף איך מקשיבים, משיבים בשאלה ומובילים לסגירה.",
  },
  {
    Icon: Target,
    title: "תקבל את תהליך המכירה המלא",
    desc: "אני אתן לך את תהליך המכירה שיוצר לך וודאות ושליטה מלאה בעסק שלך, מהפנייה הראשונה ועד הסגירה.",
  },
];
