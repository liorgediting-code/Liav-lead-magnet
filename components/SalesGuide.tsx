...
ראיתי שהשארת לי פרטים ואני חוזר אלייך בשביל שאבין איך אוכל לעזור לך!
לפני שנתחיל, יש לך 10-15 דקות עכשיו?"`,
  ...
  },
  {
    ...
    script: `"ספר לי קצת עלייך, מה אתה עושה? תקשיב
...
ככה זה נראה? יש משהו שהחמצתי?"`,
  ...
  },
  {
    number: 5,
    title: "הצגת המוצר",
    subtitle: "טכני + מה יוצא לי מזה + מה התועלת שאפיק",
    importance:
...
[שלב 1 טכני]: מה יוצא לך מזה? [מה התועלת שתפיק]
    → קיבלת את זה? מרגיש רלוונטי?

[שלב 2 טכני]: מה יוצא לך מזה? [מה התועלת שתפיק]
    → יש שאלות?
...
"איך תרצה להעביר: כרטיס אשראי או העברה בנקאית?"`,
  ...
  },
  {
    ...
    importance:
      "תמיד בהתנגדות קודם כל חשוב להיות בהסכמה ולא להתנגד כדי לא לייצר אנטיגוניזם מול הלקוח. אם הגעת לפה, כנראה שלב האבחון לא היה עמוק מספיק, או שחסרה לו וודאות. יש גם לקוחות שצריכים זמן לעכל ולסגור בהמשך. אנחנו עובדים בשיטת מערכת יחסים, לא עסקאות חד פעמיות.",
    script: `על "יקר לי":
"אני מבין ומסכים איתך שהמחיר לא הכי זול, אבל תגיד רגע מה גורם לך בעצם להגיד שיקר?
חסרה לך וודאות על התהליך או שלא מספיק הבנת את התועלת והערך לעומת מה שתשקיע?"

על "צריך לחשוב":
"שמע, גם אני כשלוקח החלטות חשובות בחיים אני אוהב לחשוב על זה, אבל ברגע שאני יודע שהדבר הספציפי שאני מתעניין בו יוכל לעזור לי לסגור את הפער שלי ולקדם אותי לעבר המטרה, אני הולך על זה!
יכול להיות שלא מספיק קיבלת וודאות וביטחון שהמוצר באמת יוכל לקדם אותך לשלב הבא?"

על "להתייעץ עם אשתי":
"מעולה! אשמח לקבל את הברכה שלה. אבל תגיד רגע שאלה, אם אשתך לא הייתה רוצה שתלך על זה, היית הולך על זה?"
[אם יגיד לא: תצטרך לבצע את המכירה מחדש מול אשתו, היא מקבלת ההחלטה. הזמן אותה לשיחה עכשיו בזמן שהוא עוד חם.]
[אם יגיד כן: הוא זה שמקבל את ההחלטה, היא רק לייעוץ. הנע אותו להעלות אותה כבר עכשיו על הקו, כי מניסיון הלקוח לא יודע להסביר את המידע כמו המוכר.]`,
    tip: "קריטי! תמיד לאחר פתירת התנגדות תניע לפעולה שוב בשביל לקבל את ההתנגדות הבאה והחשש שלו, ותפתור לו עד שתגיע למצב שאתה מניע לפעולה ואין לו יותר פחדים וחששות לגבי קבלת ההחלטה. והנה נכנס עוד לקוח לעסק!",
  },
];
