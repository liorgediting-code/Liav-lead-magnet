...
"איך תרצה להעביר: כרטיס אשראי או העברה בנקאית?"`,
  ...
  },
  {
    ...
    importance:
      "תמיד בהתנגדות קודם כל חשוב להיות בהכמה ולא להתנגד כדי לא לייצר אנטיגוניזם מול הלקוח. אם הגעת לפה, כנראה שלב האבחון לא היה עמוק מספיק, או שחסרה לו וודאות. יש גם לקוחות שצריכים זמן לעכל ולסגור בהמשך. אנחנו עובדים בשיטת מערכת יחסים, לא עסקאות חד פעמיות.",
    script: `על "יקר לי":
