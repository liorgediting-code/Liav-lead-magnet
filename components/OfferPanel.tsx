...
const screenshots = [
  "/testimonials/whatsapp-1.png",
  "/testimonials/whatsapp-2.jpg",
  "/testimonials/whatsapp-3.jpg",
];
        ...
        <div className="max-w-[680px] mx-auto px-5 py-16 md:py-20">
          ...
          <div className="text-center">
            ...
            <p className="text-white/35 text-xs mt-3">
              שיחה של 30 דקות לבדוק אם התוכנית מתאימה לך
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-navy">
        <div className="max-w-[680px] mx-auto px-5 py-14">
          ...
          <p className="text-white/55 text-sm text-center mb-8">
            30-60 דקות, אחד על אחד. לא שיחת מכירה.
          </p>
          ...
          <div className="flex flex-col gap-3 max-w-lg mx-auto mb-10">
            {callFeatures.map((item) => (
              <div
                key={item.title}
                className="flex items-start gap-4 bg-white/[0.05] rounded-xl p-4 border border-white/10"
              >
                <item.Icon
